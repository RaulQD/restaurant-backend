...
export class AuthModel {
    ...
    static async createUser(data) {
        ...
        try {
            ...
            const [userResult] = await pool.query(
                'INSERT INTO users (first_name, last_name, password, email, dni, phone) VALUES (?,?,?,?,?,?)',
                [first_name, last_name, password, email, dni, phone]
            );
            ...
            await pool.query('INSERT INTO clients (user_id) VALUES (?)', [
                userId,
            ]);
    ...
    static async createEmployee(data) {
        try {
            ...
            await pool.query(
                'INSERT INTO employees (user_id, position, salary) VALUES (?,?,?)',
            ...
            const [rolesResult] = await pool.query(
                'SELECT r.* FROM roles r JOIN user_roles ur ON r.id_rol = ur.role_id WHERE ur.user_id = ?',
                [userId]
            );
